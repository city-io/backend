...
func NewServer(shutdownCtx context.Context, cluster ports.ClusterProvider, store ports.Store, gameWorld *world.World, jwtSecret string) *Server {
	return &Server{cluster: cluster, store: store, world: gameWorld, jwtSecret: jwtSecret, shutdownCtx: shutdownCtx}
}
