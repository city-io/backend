...
var troopStats = map[domain.TroopType]TroopStat{
	domain.TroopTypeSoldier:   {Gold: 50, TrainTime: 20, FoodUpkeep: 60, PopCost: 1, MovementTicks: 4, Attack: 10, Defense: 10, HP: 100},
	domain.TroopTypeArcher:    {Gold: 75, TrainTime: 30, FoodUpkeep: 60, PopCost: 1, MovementTicks: 4, Attack: 15, Defense: 5, HP: 70},
	domain.TroopTypeCavalry:   {Gold: 150, TrainTime: 45, FoodUpkeep: 180, PopCost: 1, MovementTicks: 2, Attack: 20, Defense: 12, HP: 120},
	domain.TroopTypeArtillery: {Gold: 300, TrainTime: 60, FoodUpkeep: 120, PopCost: 3, MovementTicks: 6, Attack: 40, Defense: 3, HP: 60},
}
