...
type StreamStateResponse struct {
	...
	// does.
	Visibility    *MapVisibility `protobuf:"bytes,2,opt,name=visibility,proto3,oneof" json:"visibility,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *StreamStateResponse) GetVisibility() *MapVisibility {
	if x != nil {
		return x.Visibility
	}
	return nil
...
const file_cityio_service_v1_user_proto_rawDesc = "" +
	...
	"\x12StreamStateRequest\"\xa4\x01\n" +
	"\x13StreamStateResponse\x127\n" +
	"\bentities\x18\x01 \x01(\v2\x1b.cityio.entity.v1.EntityBagR\bentities\x12E\n" +
	"\n" +
	"visibility\x18\x02 \x01(\v2 .cityio.service.v1.MapVisibilityH\x00R\n" +
	"visibility\x88\x01\x01B\r\n" +
	"\v_visibility2\xbb\x03\n" +
	"\vUserService\x12S\n" +
...
var file_cityio_service_v1_user_proto_goTypes = []any{
	...
	(*MapVisibility)(nil),       // 13: cityio.service.v1.MapVisibility
}
var file_cityio_service_v1_user_proto_depIdxs = []int32{
	...
	13, // 6: cityio.service.v1.StreamStateResponse.visibility:type_name -> cityio.service.v1.MapVisibility
...
func file_cityio_service_v1_user_proto_init() {
	...
	file_cityio_service_v1_map_proto_init()
