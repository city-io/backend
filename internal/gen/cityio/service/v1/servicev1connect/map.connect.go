...
const (
	...
	MapServiceName = "cityio.service.v1.MapService"
)
...
func NewMapServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) MapServiceClient {
	...
	mapServiceMethods := v1.File_cityio_service_v1_map_proto.Services().ByName("MapService").Methods()
...
// GetTile calls cityio.service.v1.MapService.GetTile.
...
func (UnimplementedMapServiceHandler) GetMap(context.Context, *connect.Request[v1.GetMapRequest]) (*connect.Response[v1.GetMapResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("cityio.service.v1.MapService.GetMap is not implemented"))
}
