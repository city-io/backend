...
// 	protoc        (unknown)
// source: cityio/entity/v1/common.proto
...
func (CityType) Descriptor() protoreflect.EnumDescriptor {
	return file_cityio_entity_v1_common_proto_enumTypes[0].Descriptor()
}

func (CityType) Type() protoreflect.EnumType {
	return &file_cityio_entity_v1_common_proto_enumTypes[0]
}
...
func (BuildingType) Descriptor() protoreflect.EnumDescriptor {
	return file_cityio_entity_v1_common_proto_enumTypes[1].Descriptor()
}

func (BuildingType) Type() protoreflect.EnumType {
	return &file_cityio_entity_v1_common_proto_enumTypes[1]
}
...
var (
	file_cityio_entity_v1_common_proto_rawDescOnce sync.Once
	file_cityio_entity_v1_common_proto_rawDescData []byte
)

func file_cityio_entity_v1_common_proto_rawDescGZIP() []byte {
	file_cityio_entity_v1_common_proto_rawDescOnce.Do(func() {
		file_cityio_entity_v1_common_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_cityio_entity_v1_common_proto_rawDesc), len(file_cityio_entity_v1_common_proto_rawDesc)))
	})
...
func init() { file_cityio_entity_v1_common_proto_init() }
func file_cityio_entity_v1_common_proto_init() {
	if File_cityio_entity_v1_common_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_cityio_entity_v1_common_proto_goTypes,
		DependencyIndexes: file_cityio_entity_v1_common_proto_depIdxs,
		EnumInfos:         file_cityio_entity_v1_common_proto_enumTypes,
		MessageInfos:      file_cityio_entity_v1_common_proto_msgTypes,
	}.Build()
	File_cityio_entity_v1_common_proto = out.File
	file_cityio_entity_v1_common_proto_goTypes = nil
	file_cityio_entity_v1_common_proto_depIdxs = nil
}
