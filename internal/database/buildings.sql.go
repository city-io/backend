...
func (q *Queries) BatchUpdateBuildings(ctx context.Context, arg BatchUpdateBuildingsParams) error {
...
func (q *Queries) DeleteBuilding(ctx context.Context, buildingID string) error {
	_, err := q.db.Exec(ctx, deleteBuilding, buildingID)
	return err
}
